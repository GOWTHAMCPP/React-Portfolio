...
import HeroImage from '../assets/Gowtham.jpg'

const Hero = () => {
  return (
    <div className='bg-lightblue text-black text-center py-16'>
      <img src={HeroImage} alt=""
        className='mx-auto mb-8 w-48 h-60 rounded-full object-cover transform 
        transition-transform duration-300 hover:scale-105 '/>
      <h1 className='text-4xl font-bold'>
        I'm {" "}
        <span className='text-transparent bg-clip-text bg-gradient-to-r from-blue-800 to-blue-500'>Gowtham</span>
      ...
      <div className='mt-8 space-x-4'>
        <button
          className='bg-gradient-to-r from-blue-600 to-violet-500 text-white
